...
/**
* CreditCard gateway payment for POS
*/
class CreditCard extends \WC_Payment_Gateway {
    ...
    protected function setup_properties() {
        ...
        $this->method_title       = __( 'CreditCard', 'wepos' );
    ...
    public function process_payment( $order_id ) {
        ...
        $order->add_order_note( sprintf( __( '%1$s', 'wepos' ), $order->get_meta( 'wepos_payment_mode_credit_1', true ) ) );
