...
class WC_Report_Sales_By_Date extends WC_Admin_Report {
	...
	public function get_report_data() {
		error_log("Logging from get_report_data 1");
		if ( empty( $this->report_data ) ) {
			error_log("Logging from get_report_data 2");
			$this->query_report_data();
		}
		error_log("Logging from get_report_data 3");
		error_log(print_r($this->report_data,true));
