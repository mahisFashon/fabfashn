	...
	<table class="wpos-plugin-pricing-table">
		...
		<tfoot>
			<tr>
				...
				<a href="https://www.wponlinesupport.com/pricing/?ref=WposPratik&utm_source=WP&utm_medium=Footer-Mega-Grid&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank"><?php _e( 'View Pricing Options', 'footer-mega-grid-columns' ); ?></a></td>
			</tr>
		</tfoot>
	</table>
</div>